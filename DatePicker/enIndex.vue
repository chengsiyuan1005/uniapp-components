    ...
    <view v-if="isShow" class="picker">
        ...
        <view v-if="type!='time'" class="picker-modal">
            ...
            <view class="picker-modal-footer">
                ...
                <view class="picker-modal-footer-btn">
                    <view class="picker-btn" :hover-stay-time="100" hover-class="picker-btn-active" @click="onCancel">Cancel</view>
                    <view class="picker-btn" :style="{color}" :hover-stay-time="100" hover-class="picker-btn-active" @click="onConfirm">Confirm</view>
                </view>
            </view>
        </view>
        <!-- 时间选择器 -->
        <view v-if="showTimePicker" class="picker">
            <view class="picker-modal picker-time">
                <view class="picker-modal-header">
                    <text class="picker-modal-header-title">Select date</text>
                </view>
                <picker-view class="picker-modal-time" indicator-class="picker-modal-time-item" :value="timeValue" @change="onTimeChange">
                    <picker-view-column>
                        <view v-for="(v,i) in 24" :key="i">{{i<10?'0'+i:i}} h</view>
                    </picker-view-column>
                    <picker-view-column>
                        <view v-for="(v,i) in 60" :key="i">{{i<10?'0'+i:i}} m</view>
                    </picker-view-column>
                    <picker-view-column v-if="showSeconds">
                        <view v-for="(v,i) in 60" :key="i">{{i<10?'0'+i:i}} s</view>
                    </picker-view-column>
                </picker-view>
                <view class="picker-modal-footer">
                    <view class="picker-modal-footer-info">
